...
2. Paste the package URL:
   ...
   ```
3. Pick the version — currently **`1.0.0-beta.12`** — and add the **`Pantrix`** library to your app target.

### Package.swift

```swift
dependencies: [
    .package(url: "https://github.com/developersancho/pantrix-sdk-ios-spm.git", exact: "1.0.0-beta.12"),
],
```
...
> release you may prefer `from: "1.0.0-beta.12"` to automatically receive future
